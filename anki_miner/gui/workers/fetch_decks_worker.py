"""Factory for the deck-name fetch worker.

Short-lived: calls :meth:`AnkiService.get_deck_names` once via a shared
...
call is in flight. Used by the excluded-decks picker (Issue #38).
