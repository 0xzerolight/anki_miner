...
# nl_core_news_sm (Dutch spaCy model) CC BY-SA 4.0 attribution: shipped whenever the
# license dir exists. Lands at sys._MEIPASS/licenses/nl_core_news_sm/. The model is a
# language pack, never bundled; the notice travels because the app delivers it.
nl_core_news_sm_license_dir = os.path.join(project_root, "licenses", "nl_core_news_sm")
...
# ro_core_news_sm (Romanian spaCy model) CC BY-SA 4.0 attribution: shipped whenever the
# license dir exists. Lands at sys._MEIPASS/licenses/ro_core_news_sm/. The model is a
# language pack, never bundled; the notice travels because the app delivers it.
ro_core_news_sm_license_dir = os.path.join(project_root, "licenses", "ro_core_news_sm")
ro_core_news_sm_license_datas = []
if os.path.isdir(ro_core_news_sm_license_dir):
    ro_core_news_sm_license_datas.append(
        (ro_core_news_sm_license_dir, os.path.join("licenses", "ro_core_news_sm"))
    )

# el_core_news_sm (Greek spaCy model) CC BY-NC-SA 3.0 notices: shipped whenever the
# license dir exists. Lands at sys._MEIPASS/licenses/el_core_news_sm/. The model is a
# language pack, never bundled; the notice travels because the app delivers it.
el_core_news_sm_license_dir = os.path.join(project_root, "licenses", "el_core_news_sm")
el_core_news_sm_license_datas = []
if os.path.isdir(el_core_news_sm_license_dir):
    el_core_news_sm_license_datas.append((el_core_news_sm_license_dir, os.path.join("licenses", "el_core_news_sm")))

# fi_core_news_sm (Finnish spaCy model) CC BY-SA 4.0 attribution: shipped whenever the
# license dir exists. Lands at sys._MEIPASS/licenses/fi_core_news_sm/. The model is a
# language pack, never bundled; the notice travels because the app delivers it.
fi_core_news_sm_license_dir = os.path.join(project_root, "licenses", "fi_core_news_sm")
...
# hr_core_news_sm (Croatian spaCy model) CC BY-SA 4.0 notices: shipped whenever the
# license dir exists. Lands at sys._MEIPASS/licenses/hr_core_news_sm/. The model is a
# language pack, never bundled; the notice travels because the app delivers it.
hr_core_news_sm_license_dir = os.path.join(project_root, "licenses", "hr_core_news_sm")
hr_core_news_sm_license_datas = []
if os.path.isdir(hr_core_news_sm_license_dir):
