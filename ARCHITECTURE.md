...
- **Mining**: `EpisodeWorkerThread` (one pair), `BatchQueueWorkerThread` and `ManualPairWorkerThread` (many pairs, both with the season two-pass path).
