...
| `uv/` | Files | In-app mokuro install (Settings → Transcription & Alignment → Manga OCR): `uv/python/` holds the uv-managed CPython, `uv/mokuro/` the venv `mokuro==0.2.5` installs into (`services/mokuro_installer.py`) |
