...
Anki Miner mines Japanese, Korean, Chinese, English, Catalan, German, Portuguese, French, Spanish, Italian, Dutch, Norwegian Bokmål, Romanian, Greek, Finnish, Hungarian, Croatian, Swedish, Polish, Lithuanian and Danish. `AVAILABLE_LANGUAGES = ("ja", "ko", "zh", "en", "ca", "de", "pt", "fr", "es", "it", "nl", "nb", "ro", "el", "fi", "hu", "hr", "sv", "pl", "lt", "da")` (`languages/__init__.py`) is the full set; `config.language` names the active one. Everything that varies by language is reached through one object, so no call site branches on a language code.
