...
LEDGER: dict[str, str] = {
    ...
    "gui/controllers/anki_probe_controller.py::AnkiProbeController._on_fetch_decks_error": "recoverable",
    "gui/controllers/anki_probe_controller.py::AnkiProbeController._on_fetch_decks_finished": "recoverable",
    "gui/controllers/anki_probe_controller.py::AnkiProbeController.fetch_decks": "recoverable",
