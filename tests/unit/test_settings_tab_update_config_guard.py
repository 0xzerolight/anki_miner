...
class TestUpdateConfigGuard:
    ...
    def test_theme_only_change_preserves_unsaved_deck_edit(self, tab):
        ...
        tab.anki_panel.set_deck_name("MY_UNSAVED_DECK")
        ...
        assert tab.anki_panel.get_deck_name() == "MY_UNSAVED_DECK"
    ...
    def test_panel_field_change_triggers_reload(self, tab, tmp_path):
        ...
        # After reload, the deck combo should show the config value (not the unsaved edit).
