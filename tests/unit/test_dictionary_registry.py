...
class TestDictionaryRegistry:
    ...
    def test_backup_dir_not_enumerated_as_resource(self, tmp_path: Path):
        ...
        _seed_dict(tmp_path, "jmdict.tomb-20260721000000000001", "JMdict tombstone")
        ...
        assert registry.get("jmdict.tomb-20260721000000000001") is None
        assert (tmp_path / "jmdict.bak-20260721000000000000").is_dir()
        assert (tmp_path / "jmdict.tomb-20260721000000000001").is_dir()
