...
<p align="center">
把原汁原味的日语、中文、韩语和另外二十九种语言内容变成 Anki 词汇卡片。
</p>
...
- **分析** - 挖词历史、难度排名、里程碑。
- **工具** - 生成字幕（本地 Whisper）、重新校准字幕时间轴（ffsubsync/alass）、把媒体压缩成纯对话音频、从 yt-dlp 支持的任意网站下载视频/音频/字幕、把现成牌组中值得学习的部分复制到新牌组、为已有卡片回填字段、把漫画页面图像 OCR 成 .mokuro 文件（mokuro），以及让有声书对齐其书籍文本（有声书同步）。
- **设置** - 所有可配置项。

## 其他功能

- 挖词语言 - 日语、中文、韩语、英语、加泰罗尼亚语、德语、葡萄牙语、法语、西班牙语、意大利语、荷兰语、挪威语（书面挪威语）、罗马尼亚语、希腊语、芬兰语、匈牙利语、克罗地亚语、瑞典语、波兰语、立陶宛语、丹麦语、土耳其语、印尼语、俄语、阿拉伯语、泰语、波斯语、斯洛文尼亚语、乌克兰语、越南语、粤语和希伯来语，在设置中切换。除日语外，各语言的引擎都在应用内下载；印尼语和希伯来语无需引擎。
...
- 动画截图（见上方卡片示例）。
- 设置配置档 - 保存具名配置，并从顶栏切换。
- 重新设置挖词卡片样式 - 把当前的卡片样式重新应用到你已经生成的卡片（工具 → 卡片字段补全）。
