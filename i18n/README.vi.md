...
¹ Không có ảnh chụp AVIF và không loại bỏ khoảng lặng cho phụ đề được tạo.
...
- **Video** - khai thác một cặp video/phụ đề đơn lẻ, một thư mục hàng loạt, các URL YouTube, hoặc cả một loạt phim thành một bộ thẻ được xếp hạng theo tần suất.
...
Từ điển và danh sách tần suất cho từng ngôn ngữ khai thác, kèm liên kết tải xuống: [RESOURCES.md](../RESOURCES.md). Trình hướng dẫn thiết lập sẽ đề xuất bộ phù hợp với ngôn ngữ khai thác của bạn.
