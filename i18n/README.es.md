...
- **Video** - minera un solo par de video/subtítulo, una carpeta por lotes, URLs de YouTube o una serie completa en un solo mazo clasificado por frecuencia.
...
Diccionarios y listas de frecuencia para cada idioma de minería, con enlaces de descarga: [RESOURCES.md](../RESOURCES.md). El asistente de configuración ofrece el conjunto adecuado para tu idioma de minería.
